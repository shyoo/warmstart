...
export interface RemoteListenerInfo { listening: boolean; secure: boolean; urls: string[]; tailscale: { installed: boolean; hostname: string | null; certAvailable: boolean; error: string | null; certError: string | null; certTimedOut: boolean } | null }
