...
const info: AdapterInfo = {
  ...
  verification: {
    ...
    asOf: '2026-09-22',
    note:
      'codex-cli 0.156.0 on Windows. Flag surface, CODEX_HOME and doctor JSON shape; the running CLI ' +
      'refreshed models_cache.json on 2026-09-22, listing gpt-6-astra (priority 1), gpt-6-sol, and gpt-5.6-sol as visible models. ' +
      'gpt-6-astra and gpt-6-sol verified working on a ChatGPT Plus account (low through ultra reasoning effort). Quota, the --json event ' +
