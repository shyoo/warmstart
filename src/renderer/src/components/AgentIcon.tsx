...
/**
 * Returns the small brand icon representing the agent:
...
export function AgentIcon({
  ...
  if (id === 'claude-code' || id.includes('claude')) {
    return (
      <svg
        viewBox="0 0 24 24"
        width={size}
  ...
  if (id === 'antigravity-cli' || id.includes('antigravity') || id.includes('agy')) {
    return (
      <svg
        viewBox="0 0 112 112"
        width={size}
  ...
  if (id === 'openai-compatible' || id.includes('codex') || id.includes('openai')) {
    return (
      <svg
        viewBox="0 0 24 24"
        width={size}
  ...
  return (
    ...
    >
      ...
      <path d="M8 1v3M5 8h.01M11 8h.01M6 11h4" />
    </svg>
  )
}