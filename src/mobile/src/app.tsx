 ...
 *
 * Routes: `#/` attention, `#/quota`, `#/tasks`, `#/task/:id`, `#/new`, `#/pair?code=…`.
 ...
 */
type Route = { name: 'attention' } | { name: 'quota' } | { name: 'tasks' } | { name: 'task'; id: string } | { name: 'new' } | { name: 'pair' }
  ...
  return (
    <div className="m-app">
      ...
      <main className="m-main">
        ...
        {route.name === 'tasks' && <TasksScreen refreshKey={refreshKey} openTask={(id) => go(`#/task/${id}`)} />}
      ...
      <nav className="m-tabs">
        ...
        <TabButton active={route.name === 'new'} onPress={() => go('#/new')} label="New" />
      </nav>
    </div>
  )
}
